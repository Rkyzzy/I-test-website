import{Ct as e,E as t,F as n,L as r,M as i,Tt as a,W as o,_ as s,f as c,h as l,i as u,p as d,rt as f,u as p,v as m,z as h}from"./runtime-core.esm-bundler-rZaFWmUE.js";import{c as g,l as _,r as v,t as y}from"./index-DXUrVGbG.js";var b={class:`min-h-screen flex flex-col`},x={class:`flex-1 flex flex-col max-w-4xl mx-auto w-full`},S={key:0,class:`flex flex-col items-center justify-center h-full text-center`},C={class:`flex flex-wrap justify-center gap-3`},w=[`onClick`],T={key:0},E={key:1},D={key:1,class:`flex gap-4 animate-fade-in`},O={class:`p-6 border-t border-[#d0d7de] dark:border-[#30363d]`},k={class:`flex flex-col gap-2`},A={key:0,class:`text-sm text-[#f85149] text-center`},j={class:`flex gap-4`},M=[`disabled`],N=`https://personal-website-ai.rkyzzy.workers.dev`,P=y(m({__name:`AIChatPage`,setup(m){let y=v(),P=f([]),F=f(``),I=f(!1),L=f(``),R=f(null),z=[`介绍一下你自己`,`你目前在做什么工作？`,`你平时有什么兴趣爱好？`,`聊聊你的朋友们`];function B(){let e=y.config.profile,t=y.education,n=y.config.techStack,r=y.experience,i=t.map(e=>`- ${e.degree} in ${e.major} @ ${e.school} (${e.period}, ${e.location})`).join(`
