import{C as e,D as t,T as n,_ as r,a as i,b as a,d as o,g as s,i as c,k as l,l as u,m as d,p as f,r as p,s as m,t as h,u as g,x as _,y as v}from"./index-zJ0oDLri.js";import{t as y}from"./_plugin-vue_export-helper-BDNMzG2s.js";var b={class:`min-h-screen flex flex-col`},x={class:`flex-1 flex flex-col max-w-4xl mx-auto w-full`},S={key:0,class:`flex flex-col items-center justify-center h-full text-center`},C={class:`flex flex-wrap justify-center gap-3`},w=[`onClick`],T={key:0},E={key:1},D={class:`whitespace-pre-wrap`},O={key:1,class:`flex gap-4 animate-fade-in`},k={class:`p-6 border-t border-light-border dark:border-dark-border`},A={class:`flex gap-4`},j=[`disabled`],M=y(d({__name:`AIChatPage`,setup(d){let y=h(),M=n([]),N=n(``),P=n(!1),F=n(null),I=[`你能介绍一下自己吗？`,`你擅长哪些技术？`,`你参与过什么项目？`,`你的研究方向是什么？`],L={intro:`你好！我是基于 ${y.name} 的知识和经历训练的 AI 助手。
