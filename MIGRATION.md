...
### MileStone v4 — Inline Edit Mode

| # | 日期 | 内容 | 状态 |
|---|------|------|------|
| M15 | 2026-06-29 | 架构重构：AdminContext + EditModeBar，编辑模式内联化 | ✅ PR #22 |
| M16 | 2026-06-29 | 导航栏重构：PenLine 编辑模式开关 + LogOut 退出按钮 | ✅ |
| M17 | 2026-06-29 | Hero 页面内联编辑（bio / stats / techStack） | ✅ |
| M18 | 2026-06-29 | Blog 页面编辑模式控制（编辑/删除/新建） | ✅ |
| M19 | — | 教育/工作/AI Chat 页面的编辑模式支持 | ⏳ |

### MileStone v5 — 修复编辑模式持久化

| # | 日期 | 内容 | 状态 |
|---|------|------|------|
| M20 | 2026-06-29 | 修复 BASE_PATH 硬编码错误，数据加载不再 404 | ✅ |
| M21 | 2026-06-29 | 修复 Blog posts.json 写入路径错误 | ✅ |
| M22 | 2026-06-29 | 修复 Blog 删除不同步 posts.json 索引 | ✅ |
| M23 | 2026-06-29 | 修复 Stats 数据持久化（类型+加载+保存） | ✅ |
