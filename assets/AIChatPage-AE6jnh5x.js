import{Ct as e,E as t,F as n,L as r,M as i,Tt as a,W as o,_ as s,f as c,h as l,i as u,p as d,rt as f,u as p,v as m,z as h}from"./runtime-core.esm-bundler-rZaFWmUE.js";import{c as g,r as _,s as v,t as y}from"./index-CZ_wGD7q.js";var b={class:`min-h-screen flex flex-col`},x={class:`flex-1 flex flex-col max-w-4xl mx-auto w-full`},S={key:0,class:`flex flex-col items-center justify-center h-full text-center`},C={class:`flex flex-wrap justify-center gap-3`},w=[`onClick`],T={key:0},E={key:1},D={class:`whitespace-pre-wrap`},O={key:1,class:`flex gap-4 animate-fade-in`},k={class:`p-6 border-t border-[#d0d7de] dark:border-[#30363d]`},A={class:`flex gap-4`},j=[`disabled`],M=y(m({__name:`AIChatPage`,setup(m){let y=_(),M=f([]),N=f(``),P=f(!1),F=f(null),I=[`你能介绍一下自己吗？`,`你擅长哪些技术？`,`你参与过什么项目？`,`你的研究方向是什么？`],L={intro:`你好！我是基于 ${y.name} 的知识和经历训练的 AI 助手。
